...
<div class="page">
  <div class="container">
    <div class="page-head">
      <div>
        <h1>Projects</h1>
        <p>Group drafts by repo, service or agent fleet so a review URL has a home.</p>
      </div>
    </div>

    <div class="split">
      <div class="card">
        <h3 style="margin-bottom:1.25rem">New project</h3>
        <form method="POST" action="?/create">
          <label for="name">Name</label>
          <input id="name" name="name" placeholder="payments-service" required />
          <label for="description">Description</label>
          <input id="description" name="description" placeholder="Optional, one line" />
      ...
      <div>
        ...
        {:else}
          <div class="card card--mint empty">
            ...
            <p>Create one on the left, then pass its id when uploading to group drafts.</p>
            <div class="term">
